...
const pages = [
  ...
  { id: 'home-en', label: 'EN Landing',   src: 'https://theresathereader.com/' },
];

const FUNNEL_ID = 'theresa-the-reader';
const FUNNEL_NAME = 'Theresa The Reader';
...
export default TheresaTheReaderFunnel;
